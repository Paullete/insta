...
class ImageTestClass(TestCase):
    def setUp(self):
        ...
        self.user.save()
        self.user_profile = Profile(user=self.user,profile_picture="mypic.png")
        self.post = Image(name="views",caption="badass",user=self.user_profile)
...
class CommentsTestClass(TestCase):
    def setUp(self):
        ...
        self.post = Image(name="views",caption="badass",user=self.user_profile)
        self.post.save()
        self.comment = Comments(comment="boss wives",post=self.post,user=self.user)
